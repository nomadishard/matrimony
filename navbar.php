<nav class="navbar navbar-expand-lg navbar-light">
    ...
    <img src="../images/navlogo.png" class="d-none d-md-block d-inline-block align-top ms-2" alt="" style="max-height: 20vh;">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto" style="align-items: center;">
                <li class="nav-item active">
                    <a class="nav-link p-3" href="../home/" style="font-family: Montserrat, sans-serif; font-weight: 500; color: white;">Home</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link p-3" href="../aboutus.html" style="font-family: Montserrat, sans-serif; font-weight: 500; color: white;">About Us</a>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false" style="font-family: Montserrat, sans-serif; font-weight: 500; color: white;">
                        <?php
                        $u = $_SESSION['user_id'];
